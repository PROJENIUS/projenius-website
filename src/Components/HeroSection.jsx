...
const slides = [
    { bg: "/images/projenius-banner.webp",   thumb: "/images/projenius-banner.webp"   },
    { bg: "/images/projenius-banner-1.webp", thumb: "/images/projenius-banner-1.webp" },
    { bg: "/images/projenius-banner-2.webp", thumb: "/images/projenius-banner-2.webp" },
    { bg: "/images/projenius-banner.webp",   thumb: "/images/projenius-banner.webp"   },
    { bg: "/images/projenius-banner-1.webp", thumb: "/images/projenius-banner-1.webp" },
    { bg: "/images/projenius-banner-2.webp", thumb: "/images/projenius-banner-2.webp" },
];
...
export default function HeroSection() {
    ...
    /* Unique slides for dot indicators (only first 3 unique images) */
    const uniqueSlideCount = slides.length / 2; // 3 unique images cycling
